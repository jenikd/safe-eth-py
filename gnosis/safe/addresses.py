...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.FANTOM_SONIC_TESTNET: [
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 10, "1.3.0+L2"),
        ("0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552", 10, "1.3.0"),
        ("0x5696Ae62C36aF747966522C401FbD57492451f19", 10, "1.3.0"),
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.FANTOM_SONIC_TESTNET: [
        ...
        ("0x63B5caf390e8AF7133DBE6bA92A69167a854Ac91", 10),  # v1.3.0
    ],
    EthereumNetwork.ROOTSTOCK_MAINNET: [
